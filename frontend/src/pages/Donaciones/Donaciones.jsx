...
function getErrorMessage(error) {
    ...
    if (error.response.status === 500) return "No fue posible completar la operación. Inténtalo nuevamente más tarde.";
...
function Donaciones() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setFeedbackMessage("Tu donación quedó registrada para seguimiento. Este registro es de demostración y no procesa pagos en línea.");
            setForm(EMPTY_FORM);
        } catch (error) {
