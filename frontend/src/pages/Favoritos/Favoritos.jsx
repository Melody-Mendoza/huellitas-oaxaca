    ...
    useEffect(() => {
        ...
        const loadFavorites = async () => {
            ...
            try {
                ...
                if (!isValidPage(response.data)) { setErrorMessage("El backend devolvió una página de favoritos no compatible."); return; }
